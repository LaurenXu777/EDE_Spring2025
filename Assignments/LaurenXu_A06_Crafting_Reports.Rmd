...
```{r, echo=FALSE}
# Compute mean PM2.5 concentration for each county, round to 2 decimals, and sort by value
...
# Compute mean Ozone concentration for each county, round to 2 decimals, and sort by value
...
```{r ozone2018plot, echo=FALSE, fig.align='left', fig.height=2, fig.width=6, fig.cap="Boxplot of Ozone Levels in 2018 by Month"}
# Load required packages (if not already loaded)
library(ggplot2)
library(lubridate)
library(dplyr)

# Create a boxplot of Ozone levels by month for 2018
epa_data %>%
...
```{r ozone2019plot, echo=FALSE, fig.align='left', fig.height=2, fig.width=6, fig.cap="Boxplot of Ozone Levels in 2019 by Month"}
# Create a boxplot of Ozone levels by month for 2019
epa_data %>%
...
## Git Repository
https://github.com/LaurenXu777/EDE_Spring2025
